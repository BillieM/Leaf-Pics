...
def leafProcessor(source_image_name, source_image_path, ext, param1 = 160, param2 = 210):
    ...
    edges = cv2.Canny(denoised_image, param1, param2)
    ...
    for index,contour in enumerate(selected_contours):
        ...
        # cropped_image_path = 'out/' + source_image_name + "_" + str(index) + "." + ext
        cropped_image_path = 'out/' + source_image_name + "_" + str(index) + ".png"
